...
#include "ZenMLDataProcessPipelineWrapper.h"
#include "ZenCommon.h"
...
EXTERN_DLL_EXPORT int onNodePreInit(Node* node)
{
	...
	*((int*)(node->implementationContext)) = coreclr_create_delegates("ZenMLDataProcessPipeline", DOES_NOT_CONTAIN_DYN_ELEMENTS);
