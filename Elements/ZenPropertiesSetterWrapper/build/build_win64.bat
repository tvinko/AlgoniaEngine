...
set elementName=ZenPropertiesSetterWrapper
set elementExports=ZENPROPERTIESSETTERWRAPPER_EXPORTS

set includedirs=/I"%ZENO_ROOT%\libs\logging" /I"%ZENO_ROOT%\ZenCommon" /I"%ZENO_ROOT%\libs\ZenCoreCLR" /I"%ZENO_ROOT%\libs\pthread\src"
