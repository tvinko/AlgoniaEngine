...
set libdirs=/LIBPATH:"%ZENO_ROOT%\libs\ZenCommon\lib_msvc\1.0.0.0" /LIBPATH:"%ZENO_ROOT%\libs\ZenCoreCLR\lib\1.0.0.0" /LIBPATH:"%ZENO_ROOT%\libs\pthread\lib\1.0.0.0" /LIBPATH:"%ZENO_ROOT%\libs\Python39\libs"
set srcfiles=%elementName%.c

set libs="ZenCommon.lib" "ZenCoreCLR.lib" "libpthreadGC2.a" "python39.lib"
...
copy bin\\Debug\\%elementName%.dll  "%ZENO_ROOT%/ZenEngine/Implementations/ZenPython39.dll"