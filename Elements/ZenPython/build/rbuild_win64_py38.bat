...
set libdirs=/LIBPATH:"%ZENO_ROOT%\libs\ZenCommon\lib_msvc\Release" /LIBPATH:"%ZENO_ROOT%\libs\ZenCoreCLR\lib\Release" /LIBPATH:"%ZENO_ROOT%\libs\pthread\lib\1.0.0.0" /LIBPATH:"%ZENO_ROOT%\libs\Python38\libs"
set srcfiles=%elementName%.c

set libs="ZenCommon.lib" "libpthreadGC2.a" "ZenCoreCLR.lib" "python38.lib"
...
copy bin\Release\%elementName%.dll  "%ZENO_ROOT%\out\Implementations\ZenPython38.dll" /y