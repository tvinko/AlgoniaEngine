...
set includedirs=/I"%ZENO_ROOT%\libs\logging" /I"%ZENO_ROOT%\libs\dirent\src" /I"%ZENO_ROOT%\ZenCommon" /I"%ZENO_ROOT%\libs\ZenCoreCLR" /I"%ZENO_ROOT%\libs\pthread\src" /I"%ZENO_ROOT%\libs\Python37\include"
set libdirs=/LIBPATH:"%ZENO_ROOT%\libs\ZenCommon\lib_msvc\Release" /LIBPATH:"%ZENO_ROOT%\libs\ZenCoreCLR\lib\Release" /LIBPATH:"%ZENO_ROOT%\libs\pthread\lib\1.0.0.0" /LIBPATH:"%ZENO_ROOT%\libs\Python37\libs"
set srcfiles=%elementName%.c

set libs="ZenCommon.lib" "libpthreadGC2.a" "ZenCoreCLR.lib" "python37.lib"
...
copy bin\Release\%elementName%.dll  "%ZENO_ROOT%\out\Implementations\ZenPython37.dll" /y