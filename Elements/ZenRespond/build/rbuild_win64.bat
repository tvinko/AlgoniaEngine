...
set includedirs=/I"%ZENO_ROOT%\libs\logging" /I"%ZENO_ROOT%\libs\czmq\x64-windows\include" /I"%ZENO_ROOT%\libs\zmq\x64-windows\include"  /I"%ZENO_ROOT%\libs\cJSON\src" /I"%ZENO_ROOT%\libs\ZenCoreCLR" /I"%ZENO_ROOT%\ZenCommon" /I"%ZENO_ROOT%\libs\pthread\src"
set libdirs=/LIBPATH:"%ZENO_ROOT%\libs\zmq\x64-windows\lib" /LIBPATH:"%ZENO_ROOT%\libs\czmq\x64-windows\lib" /LIBPATH:"%ZENO_ROOT%\libs\ZenCoreCLR\lib\Release" /LIBPATH:"%ZENO_ROOT%\libs\ZenCommon\lib_msvc\Release" /LIBPATH:"%ZENO_ROOT%\libs\pthread\lib\1.0.0.0"
