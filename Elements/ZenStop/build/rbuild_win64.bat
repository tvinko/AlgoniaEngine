...
set elementName=ZenStop
set elementExports=ZENSTOP_EXPORTS

set includedirs=/I"%ZENO_ROOT%\libs\logging" /I"%ZENO_ROOT%\ZenCommon" /I"%ZENO_ROOT%\libs\pthread\src" /I"%ZENO_ROOT%\libs\ZenCoreCLR"
set libdirs=/LIBPATH:"%ZENO_ROOT%\libs\ZenCommon\lib_msvc\Release" /LIBPATH:"%ZENO_ROOT%\libs\ZenCoreCLR\lib\1.0.0.0" /LIBPATH:"%ZENO_ROOT%\libs\pthread\lib\1.0.0.0"
