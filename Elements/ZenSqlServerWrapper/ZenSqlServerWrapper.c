...
EXTERN_DLL_EXPORT int onNodePreInit(Node* node)
{
	...
	*((int*)(node->implementationContext)) = coreclr_create_delegates("Algonia.Cs.Node.SqlServer","Algonia.Cs.Node.SqlServer.ZenSqlServer", DOES_NOT_CONTAIN_DYN_ELEMENTS);
