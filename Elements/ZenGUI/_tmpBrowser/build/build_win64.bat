...
set includedirs=/I"%ZENO_ROOT%\libs\ultralight\SDK\include"  /I"%ZENO_ROOT%\libs\dirent\src" /I"%ZENO_ROOT%\ZenCommon" /I"%ZENO_ROOT%\libs\ZenCoreCLR" /I"%ZENO_ROOT%\libs\pthread\src"
set libdirs=/LIBPATH:"%ZENO_ROOT%\libs\ultralight\SDK\lib" /LIBPATH:"%ZENO_ROOT%\libs\ZenCommon\lib_msvc\1.0.0.0" /LIBPATH:"%ZENO_ROOT%\libs\ZenCoreCLR\lib\1.0.0.0" /LIBPATH:"%ZENO_ROOT%\libs\pthread\lib\1.0.0.0"
set srcfiles=%elementName%.cpp "Browser.cpp" "Tab.cpp"

set libs="ZenCommon.lib" "ZenCoreCLR.lib" "libpthreadGC2.a" "UltralightCore.lib" "AppCore.lib" "Ultralight.lib" "WebCore.lib"
