...
set libdirs=/LIBPATH:"algonia-webview\target\debug" /LIBPATH:"%ZENO_ROOT%\libs\ZenCommon\lib_msvc\Release" /LIBPATH:"%ZENO_ROOT%\libs\ZenCoreCLR\lib\Release" /LIBPATH:"%ZENO_ROOT%\libs\pthread\lib\1.0.0.0"
set srcfiles=%elementName%.c

set libs="web_view_core.dll.lib" "ZenCommon.lib" "libpthreadGC2.a" "ZenCoreCLR.lib"
...
copy algonia-webview\target\debug\web_view_core.dll "%ZENO_ROOT%\out\" /y