...
set libdirs=/LIBPATH:"%ZENO_ROOT%\libs\ultralight\SDK\lib" /LIBPATH:"%ZENO_ROOT%\libs\ZenCommon\lib_msvc\Release" /LIBPATH:"%ZENO_ROOT%\libs\ZenCoreCLR\lib\Release" /LIBPATH:"%ZENO_ROOT%\libs\pthread\lib\1.0.0.0"
set srcfiles=%elementName%.cpp

set libs="ZenCommon.lib" "libpthreadGC2.a" "ZenCoreCLR.lib" "UltralightCore.lib" "AppCore.lib" "Ultralight.lib" "WebCore.lib"
