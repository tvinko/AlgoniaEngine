...
set elementName=ZenShellExecuter
set elementExports=ZENSHEELEXECUTER_EXPORTS

set includedirs=/I"%ZENO_ROOT%\ZenCommon" /I"%ZENO_ROOT%\libs\pthread\src"
set libdirs=/LIBPATH:"%ZENO_ROOT%\libs\ZenCommon\lib_msvc\Release" /LIBPATH:"%ZENO_ROOT%\libs\pthread\lib\1.0.0.0"
